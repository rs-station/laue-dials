...
module_dir = os.path.join(__location__, "../src/laue_dials")
try:
...
try:
    from laue_dials import __version__ as version
except ImportError:
    version = ""
...
# documentation.
html_theme_options = {"sidebar_width": "300px", "page_width": "1200px", "fixed_sidebar": True, "logo_name": False}
...
htmlhelp_basename = "laue_dials-doc"
